...
const EditGameStatPage: React.FC = () => {
  ...
  const { selectedStat, label } = state;
  const defaultData: FormValues = {
    ...selectedStat,
    date: dayjs(selectedStat.date),
    player_team_name: "",
    stat_key: label
      .toLowerCase()
      .replace(/\s+/g, "_")
      .replace("goals", "goals_scored"),
  };
  ...
  return (
    <div className="page-shell space-y-4">
      <Button
        className="!normal-case !font-nunito !text-primary-700 dark:!text-primary-200"
      ...
      <Box
        ...
        >
          <Typography
            variant="h5"
            textAlign="center"
            className="!font-special !text-primary-700 dark:!text-primary-200"
          >
            Update {label} Stat
          </Typography>
        ...
        <Button
          ...
          variant="contained"
          color="primary"
          className="!text-neutral-50 !bg-primary-700 hover:!bg-primary-800 !normal-case !rounded-lg !shadow-lg !px-2 !font-special !transition-colors"
        >
          Update Game
        </Button>
      </Box>
