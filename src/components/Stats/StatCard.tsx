...
const StatCard: React.FC<StatCardProps> = ({ icon, stat, label }) => {
  return (
    <Card
      raised
      className={`absolute !bg-info-700/90 dark:!bg-info-200/70 shadow-lg hover:shadow-xl transition-shadow w-full h-full duration-300 !rounded-xl border-l-4 border-accent-100 backface-hidden`}
    >
